      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6 d-flex">
            <div class="member">
              <img src="scss/img/team/team-1.jpg" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 col-md-6 d-flex">
            <div class="member">
              <img src="scss/img/team/team-2.jpg" class="img-fluid" alt="">
              <div class="member-content">
                <h4>Sarah Jhinson</h4>
                <span>Marketing</span>
                <p>
          ...
          <div class="col-lg-4 col-md-6 d-flex">
            <div class="member">
              <img src="scss/img/team/team-3.jpg" class="img-fluid" alt="">
              <div class="member-content">
